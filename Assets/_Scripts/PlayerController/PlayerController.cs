...
namespace TarodevController {
    ...
    public class PlayerController : MonoBehaviour, IPlayerController {
        ...
        private bool _ghostSeclectChange;
        public bool _ghostHoldPowerup;
        ...
        protected virtual void GatherInput() {
            ...
            if (_frameInput.JumpDown && !_frameInput.GhostSelectHeld) {
                _jumpToConsume = true;
                _lastJumpPressed = _fixedFrame;
            }

            if (_frameInput.DashDown && !_frameInput.GhostSelectHeld) _dashToConsume = true;
            if (_frameInput.AttackDown && !_frameInput.GhostSelectHeld) _attackToConsume = true;
            if (_frameInput.GhostSelectDown) _ghostSeclectChange = true;
            _ghostHoldPowerup = _frameInput.GhostSelectHeld;
        }
        ...
        protected virtual void HandleHorizontal() {
            if (_frameInput.GhostSelectHeld) return;
            _playerAnimator._isCharging = false;
        ...
        protected virtual void HandleGhostSelection() {

            if(_ghostSeclectChange && !_ghostHoldPowerup){
                Fpressed?.Invoke();
                
            }
            _ghostSeclectChange = false;
            
            if(_ghostHoldPowerup){
                Charging?.Invoke();
            }
        ...
        protected virtual void ApplyVelocity() {
            ...
            _jumpToConsume = false;
            if(_frameInput.GhostSelectHeld){
